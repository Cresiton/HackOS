    ...
    >
      ...
      >
        <div className="flex items-start justify-between mb-4">
          ...
          <button onClick={onClose} className="text-white/30 hover:text-white/70 p-1">Γ£ò</button>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex flex-col h-full">
            <div className="space-y-3 flex-1">
              {[
                ...
                { name: "Rahul M", msg: "Dashboard looks great ≡ƒöÑ", time: "11:15 AM" },
        ...
        {["Files", "Activity"].includes(activeTab) && (
          <div className="text-center py-10">
            <div className="text-4xl mb-3">≡ƒôü</div>
...
export default function MyTeams() {
  ...
  const handleCreateTeam = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Team created successfully! ≡ƒÄë");
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="hack-card w-full max-w-md p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setShowCreateModal(false)} className="text-white/45 hover:text-white/70">Γ£ò</button>
            </div>
