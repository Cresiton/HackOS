...
async function run() {
  await testTable("conversations", ["id", "is_team", "created_at", "name", "team_id"]);
  await testTable("conversation_members", ["conversation_id", "user_id", "created_at"]);
  await testTable("messages", ["id", "sender_id", "content", "created_at", "conversation_id"]);
}
