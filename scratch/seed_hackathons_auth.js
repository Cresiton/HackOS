...
async function seed() {
  console.log("Signing up temporary organizer user...");
  const email = `organizer-${Math.random().toString().substring(2, 8)}@example.com`;
  ...
  // Wait a bit for profile triggers
